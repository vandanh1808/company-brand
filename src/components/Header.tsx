      ...
      <div className="container mx-auto px-6">
                  ...
                  {isLoadingData ? (
                    ...
                    companies.map((company) => {
                      const isCompanyActive =
                        pathname?.startsWith(`/companies/${company._id}`) ||
                        company._id === currentBrandCompanyId;
                            ...
                            >
                              ...
                              {getCompanyBrands(company._id).length > 0 ? (
                                <div className="grid grid-cols-1 gap-2 px-2 items-stretch">
                                  {getCompanyBrands(company._id).map(
                                    (brand) => {
                                      const isBrandActive =
        ...
        ${
          isBrandActive
            ...
            {/* Tuyển dụng */}
            <Link href="/recruitment" className={navLinkClass("/recruitment")}>
              Tuyển dụng
            </Link>
          </nav>
    ...
    `}
                  ...
                  <div className="pl-4 space-y-2 mt-2 bg-gray-50 rounded p-3">
                    {companies.map((company) => {
                      const isCompanyActive =
                        (isCompaniesArea &&
                          pathname?.startsWith(`/companies/${company._id}`)) ||
                        currentBrandCompanyId === company._id;
            ...
            `}
                          >
                            ...
                            <ChevronRight
                              className={`w-3 h-3 ${
                                isCompanyActive ? "text-green-600" : ""
                              }`}
                            />
                          </button>
