...
const banners: Banner[] = [
  ...
  { baseName: "fourth_banner", alt: "Banner 4" },
  { baseName: "fifth_banner", alt: "Banner 5" },
];
...
function SlidePicture({ baseName, alt }: { baseName: string; alt: string }) {
  ...
  const src1920 = `/home/${baseName}_1920x1080.png`; // mobile / nhỏ
  const src2520 = `/home/${baseName}_2520x1080.png`; // md / lg
  const src3000 = `/home/${baseName}_3000x1200.png`; // xl trở lên
