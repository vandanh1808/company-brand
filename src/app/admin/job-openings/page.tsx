...
export default function AdminJobOpeningsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "active":
        return (
          <Badge className="bg-green-100 text-green-800">Đang tuyển</Badge>
        );
      case "inactive":
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-xl">Đang tải dữ liệu tuyển dụng...</div>
        </div>
      </div>
    );
  }
    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Đang tuyển</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {jobOpenings.filter((job) => job.status === "inactive").length}
              </div>
            </CardContent>
          </Card>
          <Card>
      ...
      >
        ...
        >
          <DialogHeader>
            <DialogTitle>
              {editing ? "Chỉnh sửa tin tuyển dụng" : "Thêm tin tuyển dụng mới"}
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="quantityText">Số lượng tuyển</Label>
                <Input
                  id="quantityText"
                  name="quantityText"
