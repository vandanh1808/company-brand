        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {formData.images.length > 0 && (
              <div className="space-y-2">
                <Label>Ảnh Đã Tải Lên ({formData.images.length})</Label>
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {formData.images.length > 0 && (
              <div className="space-y-2">
                <Label>Ảnh Hiện Tại ({formData.images.length})</Label>
                {formData.images.map((imageUrl, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-2 p-2 border rounded"
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-center">
            <Button
              ...
              className={`text-xs ${
                !(searchTerm || selectedCompanyId) ? "invisible" : ""
              }`}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              {searchTerm || selectedCompanyId ? "Kết Quả Lọc" : "Hiển Thị"}
            </CardTitle>
            {(searchTerm || selectedCompanyId) && (
              ...
              <TableBody>
                {filteredProducts.map((product) => (
                  <TableRow key={product._id}>
                    ...
                    <TableCell>
                      <Badge variant="outline">{product.brandId?.name}</Badge>
                    </TableCell>
                    <TableCell>
